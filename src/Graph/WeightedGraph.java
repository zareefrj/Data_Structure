...
public class WeightedGraph<T extends Comparable<T>, N extends Comparable<N>> {
    ...
    public boolean addUndirectedEdge(T source, T destination, N w) {
        boolean toLeft = addEdge(source, destination, w);
        boolean toRight = addEdge(destination, source, w);
    ...
    public boolean removeEdge(T source, T destination) {
        ...
        while (sourceVertex != null) {
            if (sourceVertex.vertexInfo.compareTo(source) == 0) {
                ...
                Edge<T, N> currentEdge = prevEdge.nextEdge;
                if (prevEdge.toVertex.vertexInfo.compareTo(destination) == 0) { // if prev edge is source to destination
                    sourceVertex.outdeg -= 1;
                    prevEdge.toVertex.indeg -= 1;
